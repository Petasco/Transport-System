...
namespace Transport_System
{
    public partial class TICKET2 : Form
    {
        ...
        private void ADD_BTN_Click(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO ticket (Id, SeatNo,Destination, cost, Date) VALUES ('" + this.Id.Text + "','" + this.SeatNo.Text + "','" + this.Destination.Text + "','" + this.cost.Text + "','" + this.Date.Text + "');";
            ...
            cmd.Parameters.Add("@SeatNo", MySqlDbType.Int16).Value = SeatNo;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE ticket SET Id ='" + this.Id.Text + "',SeatNo='" + this.SeatNo.Text + "',Destination='" + this.Destination.Text + "',cost='" + this.cost.Text + "',Date='" + this.Date.Text + "' WHERE Id=  @Id ";
            // Create a connection object
            MySqlConnection con = GetSqlConnection();
            ...
            // Create a command object
             ...
             cmd.Parameters.AddWithValue("@costt", cost.Text);
